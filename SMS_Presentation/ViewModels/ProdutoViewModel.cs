...
namespace ERP_CRM_Solution.ViewModels
{
    public class ProdutoViewModel
    {
        ...
        [StringLength(50, ErrorMessage = "AS REFERENCIAS devem conter no máximo 50 caracteres.")]
        public string PROD_NR_REFERENCIA { get; set; }
        public string PROD_NM_ORIGEM { get; set; }
        [StringLength(50, ErrorMessage = "A LOCALIZAÇÃO NO ESTOQUE devem conter no máximo 50 caracteres.")]
        ...
        [StringLength(50, ErrorMessage = "O CÓDIGO DE BARRAS deve conter no máximo 50 caracteres.")]
        ...
        [StringLength(5000, ErrorMessage = "O INFORMAÇÃO NUTRIOCIONAL deve conter no máximo 5000 caracteres.")]
        public string PROD_DS_INFORMACAO_NUTRICIONAL { get; set; }
        public Nullable<int> PROD_IN_GERAR_ARQUIVO { get; set; }
        [StringLength(50, ErrorMessage = "O NÚMERO NVM deve conter no máximo 50 caracteres.")]
        public string PROD_NR_NCM { get; set; }
        [StringLength(14, ErrorMessage = "O GTIN EAN deve conter no máximo 14 caracteres.")]
        ...
        [StringLength(50, ErrorMessage = "A JUSTIFICATIVA deve conter no máximo 250 caracteres.")]
        public string PROD_DS_JUSTIFICATIVA { get; set; }

        public Nullable<int> PROR_CD_ID { get; set; }
        [StringLength(50, ErrorMessage = "O CÓDIGO CEST deve conter no máximo 50 caracteres.")]
        public string PROD_NR_CEST { get; set; }
        [StringLength(14, ErrorMessage = "O GTIN EAN TRIBUTÁVEL deve conter no máximo 14 caracteres.")]
        public string PROD_NR_GTIN_EAN_TRIB { get; set; }
        [StringLength(50, ErrorMessage = "A UNIDADE TRIBUTÁVEL deve conter no máximo 50 caracteres.")]
        public string PROD_NM_UNIDADE_TRIB { get; set; }
        [StringLength(50, ErrorMessage = "O FATOR DE CONVERSÃO deve conter no máximo 50 caracteres.")]
        public string PROD_NR_FATOR_CONVERSAO { get; set; }
        [StringLength(50, ErrorMessage = "O CÓDIGO DE ENQUADRAMENTO IPI deve conter no máximo 50 caracteres.")]
        public string PROD_NR_ENQUADRE_IPI { get; set; }
        [RegularExpression(@"^[0-9]+([,.][0-9]+)?$", ErrorMessage = "Deve ser um valor numérico positivo")]
        public Nullable<decimal> PROD_VL_IPI_FIXO { get; set; }

        [StringLength(50, ErrorMessage = "O SLUG deve conter no máximo 50 caracteres.")]
        public string PROD_NM_SLUG { get; set; }
        [StringLength(250, ErrorMessage = "AS KEYWORDS devem conter no máximo 250 caracteres.")]
        public string PROD_NM_KEYWORDS { get; set; }
        [StringLength(50, ErrorMessage = "O TÍTULO SEO deve conter no máximo 50 caracteres.")]
        public string PROD_NM_TITULO_SEO { get; set; }
        [StringLength(500, ErrorMessage = "A DESCRIÇÃO SEO deve conter no máximo 500 caracteres.")]
        public string PROD_DS_DESCRICAO_CEO { get; set; }
        [StringLength(50, ErrorMessage = "A TAG deve conter no máximo 50 caracteres.")]
