...
namespace ApplicationServices.Interfaces
{
    public interface IFichaTecnicaAppService : IAppServiceBase<FICHA_TECNICA>
    {
        ...
        Int32 ValidateCreateProduto(FICHA_TECNICA item, USUARIO usuario);
        ...
        Int32 ExecuteFilter(Int32? prodId, Int32? cat, String descricao, out List<FICHA_TECNICA> objeto);
